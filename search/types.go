...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"tse:GetServiceCapabilitiesResponse"`
...
type GetRecordingSummaryResponse struct {
	XMLName xml.Name `xml:"tse:GetRecordingSummaryResponse"`

	Summary *RecordingSummary `xml:"Summary,omitempty" json:"Summary,omitempty"`
}
...
type GetRecordingInformationResponse struct {
	XMLName xml.Name `xml:"tse:GetRecordingInformationResponse"`
...
type GetMediaAttributes struct {
	...
	RecordingTokens []*RecordingReference `xml:"RecordingTokens,omitempty" json:"RecordingTokens,omitempty"`

	Time soap.XSDDateTime `xml:"Time,omitempty" json:"Time,omitempty"`
}

type GetMediaAttributesResponse struct {
	XMLName xml.Name `xml:"tse:GetMediaAttributesResponse"`

	MediaAttributes []*MediaAttributes `xml:"MediaAttributes,omitempty" json:"MediaAttributes,omitempty"`
}
...
type FindRecordings struct {
	...
	Scope *SearchScope `xml:"Scope,omitempty" json:"Scope,omitempty"`
	...
	MaxMatches int32 `xml:"MaxMatches,omitempty" json:"MaxMatches,omitempty"`
	...
	KeepAliveTime xsd.Duration `xml:"KeepAliveTime,omitempty" json:"KeepAliveTime,omitempty"`
}

type FindRecordingsResponse struct {
	XMLName xml.Name `xml:"FindRecordingsResponse"`

	SearchToken JobToken `xml:"SearchToken,omitempty" json:"SearchToken,omitempty"`
}
...
type GetRecordingSearchResults struct {
	...
	MinResults int32 `xml:"MinResults,omitempty" json:"MinResults,omitempty"`
	...
	WaitTime *xsd.Duration `xml:"WaitTime,omitempty" json:"WaitTime,omitempty"`
}

type GetRecordingSearchResultsResponse struct {
	XMLName xml.Name `xml:"GetRecordingSearchResultsResponse"`

	ResultList *FindRecordingResultList `xml:"ResultList,omitempty" json:"ResultList,omitempty"`
}
...
type FindEvents struct {
	...
	StartPoint soap.XSDDateTime `xml:"StartPoint,omitempty" json:"StartPoint,omitempty"`
	...
	EndPoint soap.XSDDateTime `xml:"EndPoint,omitempty" json:"EndPoint,omitempty"`

	Scope *SearchScope `xml:"Scope,omitempty" json:"Scope,omitempty"`

	SearchFilter *EventFilter `xml:"SearchFilter,omitempty" json:"SearchFilter,omitempty"`
	...
	IncludeStartState bool `xml:"IncludeStartState,omitempty" json:"IncludeStartState,omitempty"`
...
type FindEventsResponse struct {
	XMLName xml.Name `xml:"tse:FindEventsResponse"`
...
type GetEventSearchResultsResponse struct {
	XMLName xml.Name `xml:"tse:GetEventSearchResultsResponse"`

	ResultList *FindEventResultList `xml:"ResultList,omitempty" json:"ResultList,omitempty"`
}
...
type FindPTZPosition struct {
	...
	SearchFilter *PTZPositionFilter `xml:"SearchFilter,omitempty" json:"SearchFilter,omitempty"`
...
type FindPTZPositionResponse struct {
	XMLName xml.Name `xml:"tse:FindPTZPositionResponse"`
...
type GetPTZPositionSearchResultsResponse struct {
	XMLName xml.Name `xml:"tse:GetPTZPositionSearchResultsResponse"`

	ResultList *FindPTZPositionResultList `xml:"ResultList,omitempty" json:"ResultList,omitempty"`
}
...
type FindMetadata struct {
	...
	MetadataFilter *MetadataFilter `xml:"MetadataFilter,omitempty" json:"MetadataFilter,omitempty"`
...
type FindMetadataResponse struct {
	XMLName xml.Name `xml:"tse:FindMetadataResponse"`
...
type GetMetadataSearchResultsResponse struct {
	XMLName xml.Name `xml:"tse:GetMetadataSearchResultsResponse"`

	ResultList *FindMetadataResultList `xml:"ResultList,omitempty" json:"ResultList,omitempty"`
}
...
type GetSearchStateResponse struct {
	XMLName xml.Name `xml:"tse:GetSearchStateResponse"`

	State *SearchState `xml:"State,omitempty" json:"State,omitempty"`
}
...
type EndSearchResponse struct {
	XMLName xml.Name `xml:"tse:EndSearchResponse"`
...
type NotUnderstoodType struct {
	...
	Qname *xsd.QName `xml:"qname,attr,omitempty" json:"qname,omitempty"`
}
...
type ConfigurationEntity struct {
	...
	Token *xsd.Token `xml:"token,attr,omitempty" json:"token,omitempty"`
}
...
type ItemList struct {
	SimpleItem []struct {
		...
		Value *xsd.AnySimpleType `xml:"Value,attr,omitempty" json:"Value,omitempty"`
...
type ItemListDescription struct {
	SimpleItemDescription []struct {
		...
		Type *xsd.QName `xml:"Type,attr,omitempty" json:"Type,omitempty"`
...
type ConfigDescription struct {
	...
	Name *xsd.QName `xml:"Name,attr,omitempty" json:"Name,omitempty"`
...
type RecordingTargetConfiguration struct {
	...
	SpanDuration *xsd.Duration `xml:"SpanDuration,omitempty" json:"SpanDuration,omitempty"`

	// Maximum duration of a segment.
	SegmentDuration *xsd.Duration `xml:"SegmentDuration,omitempty" json:"SegmentDuration,omitempty"`
...
func NewSearchPort(client *soap.Client) SearchPort {
	return &searchPort{
		client: client,
	}
}
