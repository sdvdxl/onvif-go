...
type GetServiceCapabilitiesResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl GetServiceCapabilitiesResponse"`
...
type GetReplayUriResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl GetReplayUriResponse"`
...
type SetReplayConfiguration struct {
	...
	Configuration *ReplayConfiguration `xml:"Configuration,omitempty" json:"Configuration,omitempty"`
}

type SetReplayConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl SetReplayConfigurationResponse"`
}
...
type GetReplayConfigurationResponse struct {
	XMLName xml.Name `xml:"http://www.onvif.org/ver10/replay/wsdl GetReplayConfigurationResponse"`
...
//
//	ReversePlayback bool `xml:"ReversePlayback,attr,omitempty" json:"ReversePlayback,omitempty"`
//
//	// The list contains two elements defining the minimum and maximum valid values supported as session timeout in seconds.
//
//	SessionTimeoutRange *FloatAttrList `xml:"SessionTimeoutRange,attr,omitempty" json:"SessionTimeoutRange,omitempty"`
//
//	// Indicates support for RTP/RTSP/TCP.
//
//	RTP_RTSP_TCP bool `xml:"RTP_RTSP_TCP,attr,omitempty" json:"RTP_RTSP_TCP,omitempty"`
//
//	// If playback streaming over websocket supported, websocket URI is provided. The scheme and IP part shall match the one used in the request (e.g. the GetServices request).
//
//	RTSPWebSocketUri xsd.AnyURI `xml:"RTSPWebSocketUri,attr,omitempty" json:"RTSPWebSocketUri,omitempty"`
//}
...
type TopicNamespaceType struct {
	...
	*ExtensibleDocumented
	...
	Name xsd.NCName `xml:"name,attr,omitempty" json:"name,omitempty"`

	TargetNamespace xsd.AnyURI `xml:"targetNamespace,attr,omitempty" json:"targetNamespace,omitempty"`
...
type Include struct {
	...
	Href xsd.AnyURI `xml:"href,attr,omitempty" json:"href,omitempty"`
}
...
type Vector2D struct {
	...
	Space xsd.AnyURI `xml:"space,attr,omitempty" json:"space,omitempty"`
}
...
type Color struct {
	...
	Colorspace xsd.AnyURI `xml:"Colorspace,attr,omitempty" json:"Colorspace,omitempty"`
...
type LocationEntity struct {
	...
	GeoSource xsd.AnyURI `xml:"GeoSource,attr,omitempty" json:"GeoSource,omitempty"`
...
type SourceReference struct {
	...
	Type xsd.AnyURI `xml:"Type,attr,omitempty" json:"Type,omitempty"`
}
...
func NewReplayPort(client *soap.Client) ReplayPort {
	return &replayPort{
		client: client,
	}
}
